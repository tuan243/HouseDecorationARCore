...
{
    public class SSDAsync : BaseImagePredictor<sbyte>
    {
        ...
        public SSDAsync(string modelPath) : base(modelPath, true)
        {
            resizeOptions.rotationDegree = -90;
        }

        async UniTask<Result[]> DetectAsync() {
