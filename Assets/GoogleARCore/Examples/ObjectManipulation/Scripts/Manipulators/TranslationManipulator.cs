...
namespace GoogleARCore.Examples.ObjectManipulation
{
    ...
    public class TranslationManipulator : Manipulator
    {
        ...
        /// </summary>
        private TransformationUtility.TranslationMode ObjectTranslationMode = TransformationUtility.TranslationMode.Horizontal;
        ...
        protected override void OnStartManipulation(DragGesture gesture)
        {
            ...
            if (angle < 10.0) 
            {
                ObjectTranslationMode = TransformationUtility.TranslationMode.Horizontal;
            } 
            else if (angle > 170) 
            {
                ObjectTranslationMode = TransformationUtility.TranslationMode.HorizontalDownWard;
            } 
            else 
            {
                ObjectTranslationMode = TransformationUtility.TranslationMode.Vertical;
            }
        }
        ...
        protected override void OnContinueManipulation(DragGesture gesture)
        {
                ...
                desiredPlacement.PlacementPosition.HasValue)
            {
                ...
                if (desiredPlacement.PlacementPlane != null)
                {
                    m_LastHit = desiredPlacement.PlacementPlane;
                }
            }
        }
        ...
        protected override void OnEndManipulation(DragGesture gesture)
        {
            ...
            ;
            // Pose desiredPose = new Pose(m_DesiredAnchorPosition, Quaternion.identity);
            // Pose desiredPose = new Pose(m_DesiredAnchorPosition, (m_LastHit as DetectedPlane).CenterPose.rotation);
            Pose desiredPose = new Pose(m_DesiredAnchorPosition, transform.rotation);
            ...
            Anchor newAnchor = m_LastHit.CreateAnchor(desiredPose);
